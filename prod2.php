...
body {
    ...
    <div class="container text-center align-items-center">
        <h1 class="display-4" style="padding-top: 10PX"; style="padding-top: 10PX">Creamy Pesto Pasta with Chicken</h1>
...
<div class="row">
  ...
  <br>
    ...
    <div class="col-lg-6">
        <img src="images/Cooking-Creamy-Pesto-Pasta.jpg" alt="Chef preparing pasta" class="img-fluid rounded">
    </div>
</div>
...
<body>
  ...
  <div class="container recipe-step">
    ...
    <h3 class="wp-block-heading" >Step 1: Prepare the pasta.</h3>
  ...
  <!-- Step 2 -->
  <div class="container recipe-step">
    <h3 class="wp-block-heading" >Step 2: Season and sear the chicken.</h3>
  ...
  <!-- Step 3 -->
  <div class="container recipe-step">
    <h3 class="wp-block-heading">Step 3: Make the sauce in the same pan.</h3>
  ...
  <!-- Step 4 -->
  <div class="container recipe-step">
    <h3 class="wp-block-heading" >Step 4: Serve  warm.</h3>
...
<div id="tasty-recipes-94185" class="tasty-recipes tasty-recipe-94185 tasty-recipes-display tasty-recipes-has-image" data-tasty-recipes-customization="primary-color.border-color"> </div>
    ...
    <div class="tasty-recipes-image" style="text-align: center;">
        <img loading="lazy" decoding="async" width="183" height="183" src="images/Creamy-Pesto-Pasta-with-Chicken(1).jpg"class="attachment-thumbnail size-thumbnail"  style="border: 4px solid #ffd700; border-radius: 10px;">
</div>

    <h2 class="tasty-recipes-title" style="color: #333; text-transform: uppercase; margin-top: 15px; text-align:center">House Creamy Pesto Pasta with Chicken</h2>
      ...
      ul {
        ...
        <li data-tr-ingredient-checkbox="checked">
            <span class="tr-ingredient-checkbox-container">
                ...
                <label for="ingredient1" >1 tablespoon<strong> oil </strong></label>
            </span>
        </li>
        <li data-tr-ingredient-checkbox="checked">
            <span class="tr-ingredient-checkbox-container">
        ...
        <li data-tr-ingredient-checkbox="checked">
            <span class="tr-ingredient-checkbox-container">
                ...
                <label for="ingredient4" >12 ounces<strong> penne (or other short-cut pasta) </strong></label>
            </span>
        </li>
        <li data-tr-ingredient-checkbox="checked">
            <span class="tr-ingredient-checkbox-container">
                <input type="checkbox" id="ingredient5">
                <label for="ingredient5" >2 tablespoons<strong> butter </strong></label>
            </span>
        </li>
        <li data-tr-ingredient-checkbox="checked">
            <span class="tr-ingredient-checkbox-container">
                <input type="checkbox" id="ingredient6">
                <label for="ingredient6" >2-4 cloves<strong> garlic, pressed </strong></label>
            </span>
        </li>
        <li data-tr-ingredient-checkbox="checked">
            <span class="tr-ingredient-checkbox-container">
                <input type="checkbox" id="ingredient7">
                <label for="ingredient7" >1 tablespoon<strong> flour </strong></label>
            </span>
        </li>
        <li data-tr-ingredient-checkbox="checked">
            <span class="tr-ingredient-checkbox-container">
                <input type="checkbox" id="ingredient8">
                <label for="ingredient8" >¼ - ½ teaspoon<strong> red pepper flakes </strong></label>
            </span>
        </li>
        <li data-tr-ingredient-checkbox="checked">
            <span class="tr-ingredient-checkbox-container">
                <input type="checkbox" id="ingredient9">
                <label for="ingredient9">¾ cup<strong> chicken stock </strong></label>
            </span>
        </li>
        <li data-tr-ingredient-checkbox="checked">
            <span class="tr-ingredient-checkbox-container">
                <input type="checkbox" id="ingredient10">
                <label for="ingredient10" >1 ¼ cup<strong> half and half </strong></label>
            </span>
        </li>
        <li data-tr-ingredient-checkbox="checked">
            <span class="tr-ingredient-checkbox-container">
                <input type="checkbox" id="ingredient11">
                <label for="ingredient11" >¼ cup  homemade or store-bought  <strong> basil pesto </strong></label>
            </span>
        </li>
        <li data-tr-ingredient-checkbox="checked">
            <span class="tr-ingredient-checkbox-container">
                <input type="checkbox" id="ingredient12">
                <label for="ingredient12">1 ¼ cup<strong> steamed broccoli florets </strong></label>
            </span>
        </li>
        <li data-tr-ingredient-checkbox="checked">
            <span class="tr-ingredient-checkbox-container">
                <input type="checkbox" id="ingredient13">
                <label for="ingredient13" >¼ cup<strong> parmesan cheese </strong></label>
            </span>
        </li>
    </ul>
</div>
