...
<body style="margin: 0; padding: 0; font-family: 'Arial', sans-serif; position: relative;">
    <main>
        ...
        <form action="" method="get">
            ...
            <input type="text" class="search-input" placeholder="Search..." name="search">
                <button type="submit" class="search-button bg-warning"><i class="fas fa-search"></i></button>
            </div>
        </form>
    ...
    <footer class="bg-dark text-light text-center py-3">
        <p>&copy; 2023 <span style="color: yellow; font-weight:bolder">YumYumYarnn</span> All rights reserved.</p>
    </footer>
