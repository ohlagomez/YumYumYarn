...
<div class="container text-center align-items-center">
    <h1 class="display-4" style="padding-top: 20px;">Toasty Cheesy Garlic Bread</h1>
...
<style>
  ...
  <div class="tasty-recipes-quick-links">
    ...
    <img src="../../images/garlic bread.jpg" alt="Delicious Pasta" class="img rounded" style="width: 850px; height: 500px;">
...
<body>
  ...
  <div class="container recipe-step">
    ...
    <h3 class="wp-block-heading" id="h-step-1-soften-your-butter">Step 1: Soften your butter.</h3>
  ...
  <!-- Step 2 -->
  <div class="container recipe-step">
    <h3 class="wp-block-heading" id="h-step-2-grate-that-garlic-right-in-there">Step 2: Grate that garlic right in there.</h3>
    ...
    <div class="tasty-recipes-details" style="color: #555; font-size: 14px; font-size:20px; ">
        <ul style="list-style-type: none; padding: 0; margin: 0;">
            <li class="author" style="margin-bottom: 10px; text-align:center ">
                ...
                <a style="color: #0066cc; text-decoration: none;" href="https://pinchofyum.com/about">Lindsay</a>
            </li>
...
<hr class="wp-block-separator has-alpha-channel-opacity">
    ...
    <li data-tr-ingredient-checkbox="checked">
        <span class="tr-ingredient-checkbox-container">
            ...
            <label for="ingredient1" data-amount="0.5">half a loaf of <strong>French bread</strong></label>
            </span>
    </li>
    <li data-tr-ingredient-checkbox="checked">
        <span class="tr-ingredient-checkbox-container">
            <input type="checkbox" id="ingredient1">
            <label for="ingredient2" data-amount="1">1 stick (1/2 cup) <strong>salted butter</strong>, cut into chunks</label>
           </li>
    <li data-tr-ingredient-checkbox="checked">
        <span class="tr-ingredient-checkbox-container">
            <input type="checkbox" id="ingredient1">
            <label for="ingredient3" data-amount="1">1 large clove <strong>garlic</strong></label>
            </li>
    <li data-tr-ingredient-checkbox="checked">
        <input type="checkbox" id="ingredient4">
        <label for="ingredient4" data-amount="0.25" >1/4 teaspoon <strong>garlic powder</strong></label>
        </li>
    <li data-tr-ingredient-checkbox="checked">
        <input type="checkbox" id="ingredient5">
        <label for="ingredient5"  data-amount="0.5">1/2 <span >cup</span> finely grated <strong>Parmesan cheese</strong></label>
       </li>
    <li data-tr-ingredient-checkbox="checked">
        <input type="checkbox" id="ingredient6">
        <label for="ingredient6" data-amount="2" >2 tablespoons <strong>minced fresh parsley</strong></label>
       </li>
</ul>
